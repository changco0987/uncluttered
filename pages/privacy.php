...
<div class="one_line_col">
  <h2 id="owner_of_the_data">
    Owner and Data Controller
      ...
      <p>Uncluttered</p>
      <p><strong>Owner contact email:</strong> uncluttered.webapp@gmail.com</p>
</div>
...
<div class="one_line_col">
  <h2 id="types_of_data">
    ...
    <p>
      ...
      first name; last name; email address; User ID.
    </p>
  ...
  <div class="one_line_col">
    <h2 id="use_collected_data">The purposes of processing</h2>
      <p>
        ...
        Contacting the User, Backup saving and management, Access to third-party accounts and Registration and authentication.
      </p>
      ...
      <ul class="for_boxes">
          ...
          <li>
            <div class="box_primary box_10 expand collapsed">
              <h3 class="expand-click w_icon_24 policyicon_purpose_10565770 iub-purpose iub-purpose-10565770">
...
These services are not activated automatically, but require explicit authorization by the User.</p>
                  ...
                  <h4 class="iub-service iub-service-9001987">Google Drive account access (Google LLC)</h4>
                  <div class="wrap">
                    <p>This service allows this Application to connect with the User's account on Google Drive, provided by Google LLC.</p>
                  </div>
          ...
          <li>
            <div class="box_primary box_10 expand collapsed">
              <h3 class="expand-click w_icon_24 policyicon_purpose_10565769 iub-purpose iub-purpose-10565769">
              ...
              <div class="expand-content" style="display: none;">
                <p>This type of service allows the Owner to save and manage backups of this Application on external servers managed by the service provider itself. The backups may include the source code and content as well as the data that the User provides to this Application.</p>
                  ...
                  <h4 class="iub-service iub-service-9001986">Backup on Google Drive (Google LLC)</h4>
                  <div class="wrap">
                    <p>Google Drive is a service to save and manage backups provided by Google LLC.</p>
                  </div>
          ...
          <li>
            <div class="box_primary box_10 expand collapsed">
              <h3 class="expand-click w_icon_24 policyicon_purpose_10565768 iub-purpose iub-purpose-10565768">
                Contacting the User
              </h3>
              <div class="expand-content" style="display: none;">
                  ...
                  <h4 class="iub-service iub-service-9001985">Contact form (this Application)</h4>
                  <div class="wrap">
                    ...
                    <p>Personal Data processed: email address; first name; last name; User ID.</p>
          ...
          <li>
            <div class="box_primary box_10 expand collapsed">
              <h3 class="expand-click w_icon_24 policyicon_purpose_10565771 iub-purpose iub-purpose-10565771">
...
Some of the services listed below may also collect Personal Data for targeting and profiling purposes; to find out more, please refer to the description of each service.</p>
                  ...
                  <h4 class="iub-service iub-service-9001988">Google OAuth (Google LLC)</h4>
                  <div class="wrap">
