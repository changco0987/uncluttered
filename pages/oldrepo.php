    ...
    <div class="container-fluid ">
        ...
        <div class="row my-2 py-2 flex-grow-1 mx-1 px-1 bg-danger">
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 bg-light d-flex flex-column justify-content-center align-items-end" style="height: 20rem;">
                <button type="button" class="btn btn-sm bg-primary mx-1 px-5"><i class="bi bi-chat-dots"></i> Chat</button>
                <button type="button" class="btn btn-sm bg-primary mx-1 px-5"><i class="bi bi-pencil-square"></i> Edit</button>
                <button type="button" class="btn btn-sm bg-primary mx-1 px-5"><i class="bi bi-gear"></i>Settings</button>
            </div>
        </div>
