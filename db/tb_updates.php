<?php
    ...
    {
        mysqli_query($conn, "INSERT INTO updatestb(title, filename, note, userAccountId, repositoryId) values('".$data->getTitle()."','".$data->getFilename()
        ."','".$data->getNote()."','".$data->getUserAccountId()."','".$data->getRepositoryId()."');");
